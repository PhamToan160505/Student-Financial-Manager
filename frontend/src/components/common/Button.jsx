...
export default function Button({
  ...
  const variants = {
    ...
    secondary: 'bg-white text-neutral-maintext border border-neutral-border hover:bg-neutral-bg focus:ring-primary shadow-sm',
    ...
    ghost: 'text-neutral-subtext hover:bg-neutral-bg hover:text-neutral-maintext focus:ring-neutral-border'
  };
